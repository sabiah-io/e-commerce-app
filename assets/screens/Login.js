...
export default function Login({ navigation }) {
    ...
    id="currentIllo" data-name="Layer 1" width="869.99994" height="520.13854" 
    viewBox="0 0 869.99994 520.13854" class="injected-svg DownloadModal__ImageFile-sc-p17csy-5 iIfSkb grid_media" 
    ...
    <path d="M996.72788,546.00953a393.41394,393.41394,0,0,0-54.82622,54.44229,394.561,394.561,0,0,0-61.752,103.194c-1.112,2.72484,3.31272,3.911,4.4123,1.21642A392.34209,392.34209,0,0,1,999.96343,549.24507c2.28437-1.86015-.97-5.08035-3.23555-3.23554Z" 
    ...
    transform="translate(-165.00003 -189.93073)" fill="#fff"/>
    <path d="M789.5,708.93073h-365v-374.5c0-79.67773,64.82227-144.5,144.49976-144.5h76.00049c79.67749,0,144.49975,64.82227,144.49975,144.5Z" 
    transform="translate(-165.00003 -189.93073)" fill="#f2f2f2"/>
    ...
    <path d="M814.17958,522.54937H740.13271l.08911-.57617c.13306-.86133,13.19678-86.439,3.56177-114.436a11.813,11.813,0,0,1,6.06933-14.5835h.00025c13.77173-6.48535,40.20752-14.47119,62.52,4.90918a28.23448,28.23448,0,0,1,9.45947,23.396Z" 
    ...
    return (
        <View style={styles.main}>
            ...
            <SvgXml height='250' width='250' xml={xml}/>
            </View>

            <View style={{marginBottom: 20, alignItems: 'center', justifyContent: 'center'}}>
                <Text style={{fontFamily: 'MontserratSemiBold', fontSize: 20}}>Knock! Knock!</Text>
            </View>
            ...
            <TouchableOpacity style={styles.facebook} onPress={() => {navigation.navigate('Home')}}>
                <Image 
                    ...
                    />
                <Text style={{fontFamily: 'MontserratRegular'}}>Continue with Facebook</Text>
            </TouchableOpacity>
        </View>
    )
}
